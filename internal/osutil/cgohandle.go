...
//	func main() {
//		val := "hello Go"
//		C.myprint(C.uintptr_t(osutil.NewHandle(val)))
//		// Output: hello Go
//	}
//
// and on the C side:
...
// of the osutil.Handle to the void* parameter, as in this variant of the
// previous example.
//
